...
description: >
  Livewire v3 specialist for Laravel 11. Generates Component classes, Blade views,
  Form Objects, handles wire:model, #[Validate], lifecycle hooks, #[Computed],
  #[Url], #[On] listeners, and Alpine.js entangle. Uses dispatch() exclusively.
tools:
  - read_file
  - create_file
  - list_project_files
